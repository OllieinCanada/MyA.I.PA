...
const assignmentPattern = /^\s*(STRIPE_SECRET_KEY|STRIPE_WEBHOOK_SECRET|OPENAI_API_KEY|VAPI_API_KEY|TWILIO_AUTH_TOKEN|ADMIN_PASSWORD|ADMIN_SESSION_SECRET|MAKE_API_TOKEN|MAKE_SIGNUP_WEBHOOK_API_KEY|INTEGRATION_API_KEY|DATABASE_URL)\s*=\s*(.+?)\s*$/;
