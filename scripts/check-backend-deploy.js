...
expectIncludes("prisma/schema.prisma", "model SignupAttempt");
...
expectIncludes("render.yaml", "healthCheckPath: /api/health/ready");
expectIncludes("server/index.js", 'app.get("/api/health/ready"');
...
expectIncludes("render.yaml", "TELEGRAM_WEBHOOK_SECRET");
expectIncludes("render.yaml", "TELEGRAM_ACTION_SIGNING_SECRET");
expectIncludes("render.yaml", "TELEGRAM_ADMIN_USER_ID");
expectIncludes("render.yaml", "TELEGRAM_GUARDED_ACTIONS_ENABLED");
expectIncludes("render.yaml", "https://api.myaipa.ca/api/webhooks/telegram/actions");
expectIncludes("server/index.js", '"/api/webhooks/telegram/actions"');
expectIncludes("server/index.js", '"/api/internal/operations/pr-landing-result"');
expectIncludes("prisma/schema.prisma", "model TelegramApprovalAction");
...
expectIncludes("render.yaml", "SIGNUP_STATUS_SECRET");
...
expectIncludes("config/backend.env.example", "SIGNUP_STATUS_SECRET=");
...
expectIncludes("config/backend.env.example", "TELEGRAM_WEBHOOK_SECRET=");
expectIncludes("config/backend.env.example", "TELEGRAM_ACTION_SIGNING_SECRET=");
expectIncludes("config/backend.env.example", "TELEGRAM_ADMIN_USER_ID=");
