...
export const Container = styled.section`
  ...
  .circle {
    ...
    background:
      radial-gradient(
        ...
        padding-box,
      linear-gradient(180deg, rgba(8, 8, 12, 0.2), rgba(8, 8, 12, 0.28)) padding-box,
      conic-gradient(#00ff9d, #60a5fa, #00e0ff, #00ff9d) border-box;
    box-shadow:
      0 10px 28px rgba(0, 0, 0, 0.22),
      0 0 34px rgba(34, 211, 238, 0.18),
      0 0 22px rgba(0, 255, 157, 0.3);
    z-index: 1;
  }
  ...
  .bottom-line {
    ...
    text-shadow:
      0 0 14px rgba(153, 246, 255, 0.28),
  ...
  @media (max-width: 768px) {
    .poster {
      min-height: auto;
      padding-top: 5vh;
      padding-bottom: calc(var(--cta-safe-height) + 16px);
    }
